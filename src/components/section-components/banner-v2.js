                  ...
                  <div className="row">
                    <div className="col-lg-12 align-self-center">
                      ...
                      <div className="slide-item-img">
                        ...
                        <img
                          src="https://tunatheme.com/tf/react/quarter-preview/quarter/assets/img/slider/61.jpg"
                          alt="#"
                        />
                      </div>
                    </div>
                ...
                <div className="container">
                  <div className="row">
                    <div className="col-lg-12 align-self-center">
                      ...
                      <div className="slide-item-img">
                        <img
                          src="https://tunatheme.com/tf/react/quarter-preview/quarter/assets/img/slider/64.jpg"
                          alt="#"
                        />
                      </div>
                    </div>
                ...
                <div className="container">
                  <div className="row">
                    <div className="col-lg-12 align-self-center">
                      ...
                      <div className="slide-item-img">
                        <img
                          src="https://tunatheme.com/tf/react/quarter-preview/quarter/assets/img/slider/62.jpg"
                          alt="#"
                        />
                      </div>
                    </div>
                ...
                <div className="container">
                  <div className="row">
                    <div className="col-lg-12 align-self-center">
                      ...
                      <div className="slide-item-img">
                        <img
                          src="https://tunatheme.com/tf/react/quarter-preview/quarter/assets/img/slider/63.jpg"
                          alt="#"
                        />
                      </div>
                    </div>
