			              ...
			              <div className="col-lg-12 align-self-center">
			                <div className="slide-item-info">
			                  <div className="slide-item-info-inner ltn__slide-animation">
			                    ...
			                    <h1 className="slide-title animated ">Search and Find <br /><span>Rental</span> House</h1>
			                ...
			                <div className="slide-item-img">
			                  ...
			                  <img src="https://tunatheme.com/tf/react/quarter-preview/quarter/assets/img/slider/61.jpg" alt="#" />
			                </div>
			              </div>
			            </div>
			          </div>
			          ...
			          <div className="container">
			            <div className="row">
			              <div className="col-lg-12 align-self-center">
			                ...
			                <div className="slide-item-img">
			                  <img src="https://tunatheme.com/tf/react/quarter-preview/quarter/assets/img/slider/64.jpg" alt="#" />
			                </div>
			              </div>
			            </div>
			          </div>
			          ...
			          <div className="container">
			            <div className="row">
			              <div className="col-lg-12 align-self-center">
			                ...
			                <div className="slide-item-img">
			                  <img src="https://tunatheme.com/tf/react/quarter-preview/quarter/assets/img/slider/62.jpg" alt="#" />
			                </div>
			              </div>
			            </div>
			          </div>
			          ...
			          <div className="container">
			            <div className="row">
			              <div className="col-lg-12 align-self-center">
			                ...
			                <div className="slide-item-img">
			                  <img src="https://tunatheme.com/tf/react/quarter-preview/quarter/assets/img/slider/63.jpg" alt="#" />
			                </div>
			              </div>
			            </div>
			          </div>
			      ...
			      <div className="ltn__slider-11-img-slide-arrow-inner">
			        <div className="ltn__slider-11-img-slide-arrow-active">
			          <div className="image-slide-item">
			            <img src="https://tunatheme.com/tf/react/quarter-preview/quarter/assets/img/slider/61.jpg" alt="Flower Image" />
			          </div>
			          <div className="image-slide-item">
			            <img src="https://tunatheme.com/tf/react/quarter-preview/quarter/assets/img/slider/64.jpg" alt="Flower Image" />
			          </div>
			          <div className="image-slide-item">
			            <img src="https://tunatheme.com/tf/react/quarter-preview/quarter/assets/img/slider/62.jpg" alt="Flower Image" />
			          </div>
			          <div className="image-slide-item">
			            <img src="https://tunatheme.com/tf/react/quarter-preview/quarter/assets/img/slider/63.jpg" alt="Flower Image" />
			          </div>
			        </div>
